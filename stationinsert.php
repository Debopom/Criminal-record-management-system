...
<html lang="en">
  ...
  <body>
    ...
    <?php
    if(isset($_POST['starea'])){
        include_once 'dbconnect.php';
        $stationarea = $_POST['starea'];
        $stationlocation = $_POST['stlocation'];
        $sql = "INSERT INTO police_station VALUES ('$stationarea' , '$stationlocation');";
        ...
        if($rs){
            ...
            echo "Station ID already exists";
        }
    }
    ?>
    </h5>
