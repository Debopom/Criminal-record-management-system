...
<html lang="en">
  ...
  <body>
    ...
    <div class="overlay">
      ...
      <form name="prisonInfo" class="needs-validation" method="post" action="prison.php">
          <div class="form-row"> 
            <div class="form-group">
              <label label for="inputZip" style="color: aliceblue; margin-top: 10px; padding-left: 45px;"><h3>Prison ID</h3></label>
              <input type="text" class="form-control" name="prisonid">
            </div>           
          </div>
          <div class="col-md-12 text-center">
            <button type="submit" class="btn btn-success" style="margin-left: 2px; margin-top: 20px;">Search</button>
            <!--<input type="submit" class="btn btn-success" style="margin-top: 10px;"></input>-->
          </div>
      </form>
    </div>
