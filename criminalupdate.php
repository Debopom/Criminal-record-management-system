...
<html lang="en">
  <head>
    ...
    <title>Criminal - Record - Update</title>
  ...
  <h5 style = "color: aliceblue; text-align: center ;padding : 50px;">
    ...
    if(isset($_POST['options'])){
        ...
        if($var == "1"){
            $sql = "UPDATE criminal SET allocated_prison  = '$updated' WHERE criminal_id = '$criminal_id';";
            $rs = $conn-> query($sql);
            if($rs){
                echo "Prison updated";
            }
        ...
        if($var == "2"){
            $sql = "UPDATE criminal SET send_date  = '$updated' WHERE criminal_id = '$criminal_id';";
            $rs = $conn-> query($sql);
            if($rs){
                echo "Send Date updated";
            }
            else{
                echo 'Error: '. $conn->error;
        ...
        if($var == "3"){
            $sql = "UPDATE criminal SET release_date  = '$updated' WHERE criminal_id = '$criminal_id';";
            $rs = $conn-> query($sql);
            if($rs){
                echo "Release date updated";
            }
            else{
                echo 'Error: '. $conn->error;
