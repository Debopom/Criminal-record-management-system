...
<html lang="en">
  ...
  <body>
    ...
    include_once 'dbconnect.php';
          ...
          if(isset($_POST['stid'])){
            ...
            $stationID = explode(",", $stid);


          $sql = "SELECT * FROM police_station WHERE station_area =\"$stationID[0]\" AND station_location =\"$stationID[1]\"";
          $rs = $conn-> query($sql);
  ...
  <div class="d-flex justify-content-center align-items-start align-self-center">
    <table  style="width:50%;  margin-top: 70px; margin-left: 70px">
      ...
      <td><h3>Station Area</h3></td>
      <td><h3>Station Location</h3></td>
  ...
  <div class="d-flex justify-content-center align-items-start align-self-center">
    <table  style="width:50%; margin-top: 70px;margin-left:-120px">
      <tr>
        
        <td><h3>Police Name</h3></td>
    ...
    $sql = "SELECT p.police_id,p.position FROM police AS p JOIN police_station AS ps ON (p.station_area = ps.station_area) AND (p.station_location= ps.station_location) WHERE ps.station_area =\"$stationID[0]\" AND ps.station_location =\"$stationID[1]\" ;";
