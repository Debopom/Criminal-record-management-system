  ...
  <body>
    ...
    <div class="overlay">
      <div class="d-flex justify-content-center">
        <form name="Police_update" class="needs-validation" method="post" action="Stationsearch.php">
          <div class="form-row"> 
            <div class="form-group">
              <label for="inputZip" style="margin-left: 35px; margin-top: 50px; margin-bottom: 10px;"><h3 style="color: aliceblue;">Stations ID</h3></label>
              <input type="text" class="form-control" name="stid">
            </div>
            
          </div>
          <button type="submit" class="btn btn-success" style="margin-left: 65px; margin-top: 20px;">Search</button>
        </form>
      </div>
